...
(() => {
  ...
  const statusZhMap = {
    ...
    "Maggot's Redemption": "马戈特的救赎",
    Matricide: "弑母",
    "Monastery Discovered": "发现修道院",
    "Moonring Mission": "月环任务",
    "Morgaine's Task": "摩甘娜的任务",
    "Mourning Song": "哀悼曲",
    "Mystery Solved": "解开谜团",
    Pathfinder: "探路者",
    "Peace in Borough": "和平的街区",
    ...
    "Shelter in the Storm": "避难小屋",
    "Shrine Secure": "圣殿的安危",
    "Something is Watching": "遭受监视",
    "Stonemason's Secret": "石匠的秘密",
    "Strange Encounters": "奇遇",
    "Supplying the Revolt": "协助起义军",
    "Tangleroot Knowledge": "熟知盘根树林",
    Tracker: "跟踪者",
    Traveler: "旅者",
    "Traveling Menhir": "巨神柱的旅行",
    "Tuathan Exploration": "探索图瓦坦",
    Underfern: "蕨海洞穴",
    "War for Avalon": "阿瓦隆战争",
    "Winds of Wyrdness": "冥尘之风",
  };
