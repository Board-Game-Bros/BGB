...
(() => {
  ...
  const pageConfigs = {
    ...
    "parallel-campaign": {
      ...
      scripts: [
        ...
        "/scripts/ahlcg-upgrade-manager.js?v=20260512c",
        "/scripts/arkham-parallel-campaign-page.js?v=20260512b",
      ],
    },
  };
  ...
  stylesheet.href = "/styles/pages/arkham_horror_lcg.css?v=20260226e";
  ...
  (async () => {
    try {
      ...
      await loadScript("/scripts/main.js?v=20260226r");
