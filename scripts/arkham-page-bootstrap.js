...
(() => {
  ...
  const pageConfigs = {
    ...
    "parallel-campaign": {
      ...
      scripts: [
        ...
        "/scripts/ahlcg-upgrade-manager.js?v=20260606a",
        "/scripts/arkham-parallel-campaign-page.js?v=20260606a",
      ],
    },
  };
  ...
  stylesheet.href = "/styles/pages/arkham_horror_lcg.css?v=20260601a";
